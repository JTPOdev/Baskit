...
fun RequestSentScreen(navController: NavController) {
    Column(
        ...
        Column (
            ...
            val verifiedBadge = R.drawable.verified
            val annotatedText = buildAnnotatedString {
                append("This badge ")
                appendInlineContent("verifiedBadge", "[Verified]")
                append(" will be displayed alongside your account name once verified.")
            }
            ...
            val inlineContent = mapOf(
                "verifiedBadge" to InlineTextContent(
                    ...
                    Image(
                        painter = painterResource(id = verifiedBadge),
            ...
            Button(
                onClick = {
                    navController.navigate("AccountActivity") {
                        popUpTo("RequestSentScreen") { inclusive = true }
                    }},
