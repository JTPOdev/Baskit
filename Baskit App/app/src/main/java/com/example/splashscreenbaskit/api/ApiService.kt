...
interface ApiService {
    ...
    fun addProduct(
        ...
        @Part("is_1pc") is1Pc: RequestBody,
        @Part("is_1_4kg") is1_4kg: RequestBody,
        @Part("is_1_2kg") is1_2kg: RequestBody,
        @Part("is_1kg") is1kg: RequestBody,
        @Header("Authorization") token: String
    ): Call<ProductResponse>

    @HTTP(method = "DELETE", path = "/product/delete", hasBody = true)
    ...
    @GET("/orders") // ALL PRODUCT ORDERS OF THE USER
