...
document.addEventListener("DOMContentLoaded", () => {
        ...
        fileInput.addEventListener("change", function () {
            ...
            if (file) {
                ...
                reader.onload = function (e) {
                    ...
                    newSlide.addEventListener("click", () => setActiveSlide(newSlide));
                    slidesContainer.appendChild(newSlide);
                    updateIndicators();
                    showSlide(document.querySelectorAll(".slide").length - 1);
                };
    ...
    window.editImage = function () {
        ...
        fileInput.addEventListener("change", function () {
            ...
            if (file) {
                const reader = new FileReader();
                reader.onload = function (e) {
                    slides[slideIndex].src = e.target.result;
                };
                reader.readAsDataURL(file);
            }
        });
    ...
    function setActiveSlide(clickedSlide) {
        let slides = document.querySelectorAll(".slide");
        slideIndex = [...slides].indexOf(clickedSlide);
        updateSlides();
    }
