...
data class ProductsResponse(
    ...
    val store_address: String,
    val store_image: String?,
    @SerializedName("is_1pc") val is1Pc: Int = 0,
    @SerializedName("is_1_4kg") val is1_4Kg: Int = 0,
    @SerializedName("is_1_2kg") val is1_2Kg: Int = 0,
    @SerializedName("is_1kg") val is1Kg: Int = 0
)
